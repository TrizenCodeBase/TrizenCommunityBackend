...
async function testSpeakerData() {
    try {
        ...
        eventsWithSpeakers.forEach((event, index) => {
            ...
            event.speakers.forEach((speaker, speakerIndex) => {
                ...
                console.log(`     - Avatar: ${speaker.avatar}`);
                console.log(`     - Image: ${speaker.image}`);
                ...
                if (speaker.socialLinks) {
                    console.log(`     - LinkedIn: ${speaker.socialLinks.linkedin}`);
                    console.log(`     - Twitter: ${speaker.socialLinks.twitter}`);
                    console.log(`     - Website: ${speaker.socialLinks.website}`);
                }
            });
        });
